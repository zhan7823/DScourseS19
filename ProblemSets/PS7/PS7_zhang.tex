...
\hline \\[-1.8ex] 
 hgc & 0.062$^{***}$ & 0.049$^{***}$ & 0.062$^{***}$ \\ 
  & (0.006) & (0.004) & (0.005) \\ 
  & & & \\ 
 collegenot college grad & 0.117$^{***}$ & 0.160$^{***}$ & 0.117$^{***}$ \\ 
  & (0.039) & (0.026) & (0.029) \\ 
  & & & \\ 
 ...
 age & $-$0.003 & $-$0.001 & $-$0.003 \\ 
  & (0.003) & (0.002) & (0.002) \\ 
  & & & \\ 
 marriedsingle & $-$0.023 & $-$0.029$^{**}$ & $-$0.023 \\ 
  & (0.020) & (0.014) & (0.016) \\ 
  & & & \\ 
 Constant & 0.735$^{***}$ & 0.833$^{***}$ & 0.735$^{***}$ \\ 
  & (0.165) & (0.115) & (0.130) \\ 
  & & & \\ 
\hline \\[-1.8ex] 
Observations & 1,296 & 2,229 & 1,665 \\ 
R$^{2}$ & 0.204 & 0.132 & 0.269 \\ 
Adjusted R$^{2}$ & 0.201 & 0.130 & 0.266 \\ 
Residual Std. Error & 0.347 (df = 1290) & 0.311 (df = 2223) & 0.306 (df = 1659) \\ 
F Statistic & 66.264$^{***}$ (df = 5; 1290) & 67.496$^{***}$ (df = 5; 2223) & 121.910$^{***}$ (df = 5; 1659) \\ 
\hline 
\hline \\[-1.8ex] 
